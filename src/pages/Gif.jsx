        ...
        <div className="flex gap-6">
          <div className="w-full sm:w-3/4">
            ...
            <div className="flex sm:hidden gap-1">
              ...
              <button className="ml-auto cursor-pointer" onClick={shareGif}>
          ...
          <div className="hidden sm:flex flex-col gap-5 mt-6">
            <button
              ...
              className="flex cursor-pointer gap-5 items-center font-bold text-lg"
            >
              <HiMiniHeart
                size={30}
                className={`${
            ...
            <button
              ...
              className="flex gap-6 cursor-pointer items-center font-bold text-lg"
            >
              <FaPaperPlane size={25} />
              Share
            </button>
            <button
              ...
              className="flex gap-5 items-center cursor-pointer font-bold text-lg"
            >
              <IoCodeSharp size={30} />
              Embed
            </button>
